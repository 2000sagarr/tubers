...
SECRET_KEY = 'jez$z-v9*vfs3wj01vuf(6_@b9*78b&f%%_4kgyj4*g5dnpbtm'
...
# after python manage.py collectstatic ->static file are collected at static_root
# import os should
STATIC_ROOT = os.path.join(BASE_DIR, "static")

# it collects the static files by user
STATICFILES_DIRS = [
